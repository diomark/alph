...
**Note** - please use the updated script at https://github.com/diomark/alph/blob/main/miningAlphOnVast.md#updated-script-to-use-the-latest-054-miner-as-well-as-the-020-mining-proxy
```
#!/bin/bash
if [[ ! -f config.json ]]
then
